...
google_credentials_path = "path_of_google_cred_file"
...
llm = VertexAI(
    model_name="gemini-1.5-flash-002",   # specify the Gemini model version
    project="project_id",
    location="location",   # or another appropriate region
    temperature=0.2
)
